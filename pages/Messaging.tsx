                 ...
                 {messages.map(msg => (
                   <tr key={msg.id} className="hover:bg-gray-800/50 group">
                     ...
                     <td className="px-4 py-3 align-top">
                        ...
                        <span className={`inline-block mt-2 text-[10px] font-bold px-1.5 py-0.5 rounded border ${
                            msg.status === SmsStatus.DELIVERED ? 'border-emerald-500/30 text-emerald-500 bg-emerald-500/10' :
